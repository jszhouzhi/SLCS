...
public class AccountDO implements Serializable {
	...
	//特种卡审核状态
	private int subAccountState;
	//特种卡审核状态名
	private String subAccountStateName;
	
	private Date subAccountExpiredDate;
	
	
	private String vipMemberID; //会员类型ID
	private Date vipExpireDateTime;//会员过期时间
	
	private String openId;
	
	private String refundBalance;
	
	private String signing; // 是否免密支付签约   null否
	...
	public Date getVipExpireDateTime() {
		return vipExpireDateTime;
	}
	...
	public void setVipExpireDateTime(Date vipExpireDateTime) {
		this.vipExpireDateTime = vipExpireDateTime;
	}
	...
	public void setSubAccountState(int subAccountState) {
	...
	public String getSubAccountStateName() {
		return subAccountStateName;
	}
	...
	public void setSubAccountStateName(String subAccountStateName) {
		this.subAccountStateName = subAccountStateName;
	}
	...
	public Date getSubAccountExpiredDate() {
		return subAccountExpiredDate;
	}
	...
	public void setSubAccountExpiredDate(Date subAccountExpiredDate) {
		this.subAccountExpiredDate = subAccountExpiredDate;
	}
	...
	public AccountDO(Integer id, String merchantcode, Integer uid, Integer accounttype, String accountno,
			...
			String certPhotoBackUrl, String personphotourl, String personPhotoBackUrl, String confirmPhotoUrl,
			Integer createdby, Date createddate, Integer updatedby, Date updateddate, String remark, String certmac,
			String accountTypeName, String stateName, String auditDesc) {
		super();
		this.id = id;
