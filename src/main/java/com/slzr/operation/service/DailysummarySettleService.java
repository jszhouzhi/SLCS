...
public interface DailysummarySettleService{
	...
	void updateAudit(String id,int auditvalue,int chkuserid);
	
	void updateTransStatus(String id,int chkuserid,String remark,BigDecimal amount,Date transdate,String transno,int transstatus);
}