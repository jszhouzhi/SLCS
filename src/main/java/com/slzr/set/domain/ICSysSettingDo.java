...
public class ICSysSettingDo {
	...
	public M1SysSetting getM1SysSetting() {
		JSONObject jsonObject = JSONObject.parseObject(m1);
	...
	public JTSysSetting getJtSysSetting() {
		JSONObject jsonObject = JSONObject.parseObject(jt);
	...
	public SLSysSetting getSlSysSetting() {
		JSONObject jsonObject = JSONObject.parseObject(sl);
	...
	public ZJSysSetting getZjSysSetting() {
		JSONObject jsonObject = JSONObject.parseObject(zj);
