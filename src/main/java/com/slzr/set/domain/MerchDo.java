...
public class MerchDo implements Serializable {
    ...
    private int autoAuditCancelDays; //注销申请自动审核天数
    
    // 非平台账号结算费率
    private Double onlySettleRate;

    
    private Integer topupFeeType; //充值服务费收取类型（1：固定金额； 2：按充值金额）
    private Double topupFee; //充值服务费（当TopupFeeType=1时，为具体的服务费； 当TopupFeeType=2时，为百分比）
    
    private  String merchantCodeIC; //IC商户代码配置
    private  String apiUrlIC; //IC系统接口API
    
    private  Integer aAApplyExpireDays; //年审申请过期天数
    private  Integer aAConfirmExpireDays; //年审写卡确认过期天数
    
    
    

    public Integer getaAApplyExpireDays() {
		return aAApplyExpireDays;
	}

	public void setaAApplyExpireDays(Integer aAApplyExpireDays) {
		this.aAApplyExpireDays = aAApplyExpireDays;
	}

	public Integer getaAConfirmExpireDays() {
		return aAConfirmExpireDays;
	}

	public void setaAConfirmExpireDays(Integer aAConfirmExpireDays) {
		this.aAConfirmExpireDays = aAConfirmExpireDays;
	}
	...
	public String getApiUrlIC() {
		return apiUrlIC;
	}

	public void setApiUrlIC(String apiUrlIC) {
		this.apiUrlIC = apiUrlIC;
	}

	public Integer getTopupFeeType() {
		return topupFeeType;
	}

	public void setTopupFeeType(Integer topupFeeType) {
		this.topupFeeType = topupFeeType;
	}
	...
	public int getAutoAuditCancelDays() {
		return autoAuditCancelDays;
	}

	public void setAutoAuditCancelDays(int autoAuditCancelDays) {
		this.autoAuditCancelDays = autoAuditCancelDays;
	}
