 ...
 *  jsonobj.put("UID", "240");
    jsonobj.put("AccountNO", "03578888043006730001");
...
/*		String UserName = "WECHAT.oSEhPwKIXVHQnp4p1t0lxYrUdK_Y";
		...
		String UserName = "WECHAT.oeRFkxEOZ-1c_m10SfI8qkutADy0";
		String Password = "3E915816F73821461FAAF138AA59AAA8";
		String url ="https://www.pointlife365.net:8089/api/sl/GetToken";  //签名接口
		...
		String msgurl = "https://www.pointlife365.net:8089/api/sl/PostAccountDebit";
		String appKey = "A0E6C376000F44AEF13F58614C379DD9";
		...
		jsonobj.put("UID", "21455");
		jsonobj.put("AccountNO", "03578888043003910004");
        paraMap2.put("Data", jsonobj.toString());  
