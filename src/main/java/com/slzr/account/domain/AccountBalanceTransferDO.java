...
public class AccountBalanceTransferDO implements Serializable {
	...
	//实时Account表余额
	private BigDecimal realAccountBalance;
	//实时Account表赠送的余额
	private BigDecimal realAccountFreeBalance;
	
	private String auditResultName;
	private String userConfirmResultName;
	...
	public BigDecimal getRealAccountFreeBalance() {
		return realAccountFreeBalance;
	}

	public void setRealAccountFreeBalance(BigDecimal realAccountFreeBalance) {
		this.realAccountFreeBalance = realAccountFreeBalance;
	}

	public BigDecimal getRealAccountBalance() {
		return realAccountBalance;
	}

	public void setRealAccountBalance(BigDecimal realAccountBalance) {
