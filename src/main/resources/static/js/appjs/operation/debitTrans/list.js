...
function excel(){
	layer.confirm('确定导出吗?', {
		...
		//elseparams+='&debitFrom=' + $('#debitFrom').val();
		var debitFrom = $('#debitFrom').val();
		window.location.href= prefix + '/expexcel?searchvalue=' + $('#searchName').val() + '&sdate=' + $('#sdate').val() + '&edate=' + $('#edate').val() + '&debitFrom=' +debitFrom+elseparams;
	}, function(){
	});
}
function over(o)
